...
public class GameScreen implements Screen, InputProcessor {
    ...
    protected void Initialize() {
        ...
        season = randomizer.nextFloat() * 1000;
    ...
    public void update() {
        ...
        if (weatherTimer > 2) {
            ...
            System.out.println("Start Weather Cycle:");
            ...
            weatherText.setText("Rain: " + Weather.getRain());

            explodeDistance = Math.round(TsukamotoFuzzy.inferenceLinear(160000, 40000, Weather.getFuzzifiedRain()));
